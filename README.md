...
--------------------
The Game
![image](https://github.com/user-attachments/assets/95a750d5-52fd-4362-b35c-f6cb9841ec2e)

------------------

Technologies Used: HTML, CSS, Javascript, Vite, React

Features Implemented: incremental difficulty, useStates, scorekeeping.

Learning Opportunities: I really need to find a good API to use.

Demo Link: https://project-odin-memory-cards.vercel.app/
